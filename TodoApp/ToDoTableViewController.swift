...
class ToDoTableViewController: UITableViewController, MCSessionDelegate, MCBrowserViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        navBar?.largeTitleTextAttributes = [NSAttributedStringKey.foregroundColor: UIColor.orange]
        setupConnectivity()
        loadData()
    }
    ...
    func addNewTodo() {
        let addAlert = UIAlertController(title: "New Task", message: "What's on your mind ?", preferredStyle: .alert)
    ...
    override func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        shareAction.backgroundColor = UIColor(named: "mainBackgroundColor")
